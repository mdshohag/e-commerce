	...
	<div class="col-md-3" style="padding-left:0px;">
		...
		<div class="maincontent-area" style="padding-top: 0px;">
			...
			<div class="container">
				...
				?>
				<div class="row">
                    <h2 class="section-title" style="color:white"><?php echo $pr_typ['typename']; ?></h2>
					...
					<div class="col-md-3" style="padding-left:3px;padding-right:35px;padding-bottom:15px;">
						<div class="single-product" style="border:1px solid #ffd6cc;padding-bottom:8px;">
							<div class="product-f-image" style="height:235px" >
                                ...
                                <h2 style="font-family: Georgia, serif;font-size:14px;"><a href="single-product/book_id/<?php echo $bid; ?>"><?php echo $view_pro['title'];?></a></h2>

                                <div class="product-carousel-price">
                                    <ins style="color: #208000;font-size: 13px;font-weight: bold;"><?php echo $view_pro['price'];?></ins>
                                </div>                            
                            </div>
						</div>
                            <?php
